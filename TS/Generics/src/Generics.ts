...
const enymycopy = cloneShip(falcon, "Enemy", "Enymy");

const enymycopy2 = cloneShip<EnemyShip>(falcon, "Enemy", "Enymy");

//sem propriedade opcional
// enymycopy.flag = "imperial";
//com proprieade opcional
enymycopy2.flag = "imperial";
